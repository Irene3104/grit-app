  ...
  return (
    ...
    >
      ...
      <div style={styles.list}>
        ...
        <motion.button whileTap={{ scale: 0.95 }} style={styles.addBtn} onClick={addTodo}>
          + add
        </motion.button>
      </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  list: { width: '100%', maxWidth: '420px', display: 'flex', flexDirection: 'column', gap: '0.8rem' },
  todoRow: { display: 'flex', alignItems: 'center', gap: '0.6rem' },
  num: { color: '#ffffff60', fontSize: '0.9rem', minWidth: '1.2rem' },
  input: {
    flex: 1, background: 'transparent', border: 'none', borderBottom: '1.5px solid #ffffff30',
    color: '#ffffff', fontSize: '1rem', padding: '0.6rem 0', outline: 'none',
  },
  remove: { background: 'none', border: 'none', color: '#ffffff40', cursor: 'pointer', fontSize: '0.9rem' },
  addBtn: {
    background: 'none', border: '1px dashed #ffffff30', color: '#ffffff60',
    borderRadius: '8px', padding: '0.6rem', cursor: 'pointer', fontSize: '0.95rem', marginTop: '0.3rem',
  },
  button: {
